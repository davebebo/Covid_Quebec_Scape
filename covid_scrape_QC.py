...
filename = "data_QC/Covid_data_QC_" + today.strftime("%Y") + "_" + today.strftime("%m") + "_" + today.strftime("%d")
...
#Filter trough elements of table and output everything after the first region listed as 01, formated to text file
while i < table_len - 1:
	if "01 - " in table[i]:
		first_table_elem = 1
